...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Sym is held with the left thumb.                                                                          | Symbols used by the left hand while Sym is held belong on the home row; other left-hand reaches are awkward. |
| The right bottom keywell row is easy to reach and sits inline with the upper thumb-cluster keys.          | The bottom `-` `+` pair is the primary operator pair.                                                        |
| The inner edge of either keywell is a rough reach.                                                        | Avoid using unless keys are particularly infrequent                                                          |
